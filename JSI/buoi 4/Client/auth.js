...
function createMatrixEffect() {
    ...
    matrixBg.style.position = 'fixed';
    matrixBg.style.inset = '0';
    matrixBg.style.width = '100vw';
    matrixBg.style.height = '100vh';
    matrixBg.style.zIndex = '-1';
    matrixBg.style.background = '#1a1a1a';
    matrixBg.style.pointerEvents = 'none';
    document.body.appendChild(matrixBg);

    const columnWidth = 24;
    const rowHeight = 20;
    const columns = Math.ceil(window.innerWidth / columnWidth) + 2;
